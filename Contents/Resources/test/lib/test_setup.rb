...
TEST_OPTIONS_URL = { url: SERVER_URL }.freeze
TEST_OPTIONS_URL_PORT = { port: SERVER_PORT, url: SERVER_URL }.freeze
...
TEST_ESCAPE_FILE3 = File.join(TEST_DATA_DIR,
                              'output_with_escapes3.txt')
